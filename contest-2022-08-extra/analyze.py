...
normals = {
  "java -jar AdvancedAvocadoAgent/advanced-avocado-agent/agent/build/libs/agent-all.jar": "AdvancedAvocadoAgent",
  "python3 Ag2O/play.py": "Ag2O",
  "python3 Baseline1/main.py": "Baseline1",
  "python3 Baseline2/main.py": "Baseline2",
  "./Chad/agent/target/release/agent": "Chad",
  "./Coac/main": "Coac",
  "mono ./DrainPower/DrainPower.exe": "DrainPower",
  "mono ./DrainPower/DrainPower.exe aggressive": "DrainPowerAggressive",
  "java -cp LANE_1_0 Player": "LANE_1_0",
  "./OneLaneIsEnough/main": "OneLaneIsEnough",
  "python3 ReinforcedGreediness/agent.py": "ReinforcedGreediness",
  "python3 ByteRL/locm1d2_submit.py": "ByteRL"
}
